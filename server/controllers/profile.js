  ...
  try {
    ...
    const updatedAlumni = await prisma.alumni.update({
      ...
      data: {
        ...
        phoneNumber: phoneNumber?.toString() || alumni.phoneNumber,
        whatsappNumber: whatsappNumber?.toString() || alumni.whatsappNumber,
        secondaryPhoneNumber: secondaryPhoneNumber?.toString() || alumni.secondaryPhoneNumber,
