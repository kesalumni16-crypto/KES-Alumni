          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-3 py-2 border border-gray-300 rounded-md text-sm disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition duration-300"
              >
                Previous
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <ReportCard
            ...
            actions={[
              ...
              { label: 'Export JSON', action: () => exportData('json'), color: 'blue' },
            ]}
          />
          <ReportCard
            icon={<FaChartBar />}
