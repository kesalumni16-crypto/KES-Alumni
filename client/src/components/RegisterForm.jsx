      ...
      <div className="relative z-10 w-full max-w-4xl max-h-[90vh] overflow-hidden">
        <div className="bg-white rounded-lg shadow-xl flex flex-col h-full">
          <div className="sticky top-0 bg-white border-b border-gray-200 p-4 sm:p-6 flex justify-between items-center rounded-t-lg z-10">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800">KES Alumni Portal – Terms and Conditions</h2>
            <button
          ...
          <div className="p-4 sm:p-6 overflow-y-auto flex-1 text-sm text-gray-700 space-y-4">
  ...
  const ProgressIndicator = () => {
    ...
    return (
      <div className="mb-6 sm:mb-8">
        <div className="flex items-center justify-between max-w-full sm:max-w-2xl mx-auto px-2">
          {STEPS.map((step, idx) => (
            <div key={step} className="flex items-center">
              <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-medium ${
                ...
                {idx < stepIndex ? <FaCheckCircle className="text-xs sm:text-sm" /> : idx + 1}
              </div>
              {idx < STEPS.length - 1 && (
                <div className={`w-4 sm:w-12 h-1 mx-1 sm:mx-2 ${
        ...
        <div className="flex justify-between max-w-full sm:max-w-2xl mx-auto mt-2 text-xs text-gray-600 px-2">
          {STEPS.map((step) => (
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="max-w-md w-full bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Join KES Alumni</h2>
            <p className="text-sm sm:text-base text-gray-600">Connect with fellow alumni and stay updated with KES community</p>
          </div>

          <div className="mb-4 sm:mb-6 space-y-3">
            <button
              onClick={() => toast.info('LinkedIn registration coming soon!')}
              className="w-full flex items-center justify-center gap-3 border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white py-2.5 sm:py-3 px-4 rounded-lg font-medium transition-all duration-300 text-sm sm:text-base"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white py-2.5 sm:py-3 px-4 rounded-lg font-medium transition-all duration-300 text-sm sm:text-base"
            >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="pl-10 w-full px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 text-sm sm:text-base"
                />
              </div>
            </div>
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-red-600 text-white py-2.5 sm:py-3 px-4 rounded-lg font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            >
        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-gray-100">
          <div className="p-6 sm:p-8 text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">
              ...
              <span className="font-medium text-gray-900 break-all">{formData.email}</span>
            </p>
            ...
            <button
              ...
              className="w-full bg-red-600 hover:bg-red-700 text-white py-2.5 sm:py-3 px-4 rounded-lg font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mb-4 text-sm sm:text-base"
            >
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 py-4 sm:py-8">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 sm:p-8">
            <div className="text-center mb-6 sm:mb-8">
              <FaUser className="text-3xl sm:text-4xl text-red-600 mx-auto mb-4" />
            ...
            <form onSubmit={handlePersonalSubmit} className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 text-sm sm:text-base"
                  />
                </div>
                <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6">
                <button
                  ...
                  className="w-full sm:flex-1 py-2.5 sm:py-3 px-4 sm:px-6 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 font-medium transition-all duration-300 text-sm sm:text-base"
                >
                  Back
                </button>
                <button
                  type="submit"
                  className="w-full sm:flex-1 py-2.5 sm:py-3 px-4 sm:px-6 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium transition-all duration-300 text-sm sm:text-base"
                >
                  Continue
                </button>
              </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 py-4 sm:py-8">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 sm:p-8">
            <div className="text-center mb-6 sm:mb-8">
              <FaPhone className="text-3xl sm:text-4xl text-red-600 mx-auto mb-4" />
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Contact Information</h1>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full sm:w-32 px-3 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 text-sm sm:text-base"
                  >
                  ...
                  <input
                    ...
                    required
                    className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 text-sm sm:text-base"
                  />
                </div>
              </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 py-4 sm:py-8">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 sm:p-8">
            <div className="text-center mb-6 sm:mb-8">
              <FaMapMarkerAlt className="text-3xl sm:text-4xl text-red-600 mx-auto mb-4" />
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Address Information</h1>
              <p className="text-sm sm:text-base text-gray-600">Where do you currently live?</p>
            </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 py-4 sm:py-8">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 sm:p-8">
            <div className="text-center mb-6 sm:mb-8">
              <FaGraduationCap className="text-3xl sm:text-4xl text-red-600 mx-auto mb-4" />
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Academic Information</h1>
              <p className="text-sm sm:text-base text-gray-600">Tell us about your educational background at KES</p>
            </div>
            
            <form onSubmit={handleAcademicSubmit} className="space-y-4 sm:space-y-6">
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 disabled:bg-gray-100 text-sm sm:text-base"
                  required
                >
                  <option value="">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6">
                ...
                <button
                  ...
                  className="w-full sm:flex-1 py-2.5 sm:py-3 px-4 sm:px-6 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                >
